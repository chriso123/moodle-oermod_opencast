...
$string['message:failedvideos_body'] = 'Die Videos konnten nicht veröffentlicht werden. Bitte überprüfen Sie dieses Problem. Möglicherweise wird dieses Problem beim nächsten Ausführen des geplanten Tasks behoben.';
...
$string['notify_on_error_description'] = 'Eine Aufgabe überprüft, ob die Videos auf Opencast weiterhin als öffentlich eingestellt sind und ob die Rollen, die keinen Schreibzugriff haben sollen (oermod_opencast|rolestoremovewrite Einstellung), korrekt festgelegt sind. Sollte etwas nicht stimmen, wird eine E-Mail an die angegebene Adresse gesendet. Ist keine Adresse hinterlegt, wird die E-Mail an den Hauptadministrator gesendet. Es gibt außerdem eine Fähigkeit (oermod/opencast:missingvideos), die Nutzer:innen zugeordnet werden kann, falls weitere Nutzer:innen benachrichtigt werden sollen.';
